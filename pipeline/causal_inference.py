...
class CausalInferencePipeline(torch.nn.Module):
    ...
    def inference(
        ...
        # uncomment this code block when OOM happens during VAE decoding at 1080P
        # output_cuda1 = output.to('cuda:1')
        # self.vae.to('cuda:1')
        # with torch.cuda.device('cuda:1'):
        #     video = self.vae.decode_to_pixel(output_cuda1, use_cache=False)
